...
<li>Common pitfall: CAN bus termination resistance — both ends must have 120 Ω; missing termination causes reflections</li>
        ...
        relatedTopics: [{"level": "level3", "index": 4, "label": "Embedded Security Fundamentals"}, {"level": "level2", "index": 4, "label": "Power Management and Low-Power Design"}, {"level": "level3", "index": 0, "label": "Real-Time Operating Systems (RTOS)"}, {"level": "level4", "index": 4, "label": "Capstone Project \u2014 System Integration"}],
...
<li>Common pitfall: optimizing non-bottleneck code; always profile before touching anything</li>
        ...
        relatedTopics: [{"level": "level1", "index": 1, "label": "Microcontroller Architecture Fundamentals"}, {"level": "level3", "index": 0, "label": "Real-Time Operating Systems (RTOS)"}, {"level": "level3", "index": 2, "label": "Debugging and Fault Diagnosis"}, {"level": "level2", "index": 3, "label": "Memory Architecture and Management"}],
...
<li>Common pitfall: assuming firmware can compensate for hardware design errors — some problems require PCB spins</li>
        ...
        relatedTopics: [{"level": "level1", "index": 3, "label": "GPIO and Pin Control"}, {"level": "level2", "index": 2, "label": "Analog-to-Digital Conversion"}, {"level": "level3", "index": 4, "label": "Embedded Security Fundamentals"}, {"level": "level4", "index": 4, "label": "Capstone Project \u2014 System Integration"}],
...
<li>Common pitfall: safety assertions only in test builds; production firmware must also run checks</li>
        ...
        relatedTopics: [{"level": "level3", "index": 4, "label": "Embedded Security Fundamentals"}, {"level": "level3", "index": 2, "label": "Debugging and Fault Diagnosis"}, {"level": "level2", "index": 3, "label": "Memory Architecture and Management"}, {"level": "level4", "index": 4, "label": "Capstone Project \u2014 System Integration"}],
...
<li>Common pitfall: lack of crash dump storage — field failures become impossible to reproduce</li>
        ...
        relatedTopics: [{"level": "level3", "index": 3, "label": "Bootloaders and Firmware Updates"}, {"level": "level3", "index": 4, "label": "Embedded Security Fundamentals"}, {"level": "level4", "index": 3, "label": "Safety-Critical Firmware Design"}, {"level": "level3", "index": 2, "label": "Debugging and Fault Diagnosis"}, {"level": "level3", "index": 0, "label": "Real-Time Operating Systems (RTOS)"}, {"level": "level4", "index": 0, "label": "Communication Protocols for IoT"}],
