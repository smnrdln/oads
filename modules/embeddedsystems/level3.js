...
<li>Common pitfall: mutex deadlock from recursive lock attempts</li>
        ...
        relatedTopics: [{"level": "level1", "index": 4, "label": "Interrupts and Event-Driven Programming"}, {"level": "level2", "index": 1, "label": "Timers, PWM, and Capture/Compare"}, {"level": "level2", "index": 4, "label": "Power Management and Low-Power Design"}, {"level": "level3", "index": 1, "label": "Device Driver Development"}],
...
<li>Common pitfall: driver that \`while(1)\`-polls in ISR context</li>
        ...
        relatedTopics: [{"level": "level1", "index": 4, "label": "Interrupts and Event-Driven Programming"}, {"level": "level2", "index": 0, "label": "Serial Communication Protocols \u2014 UART, SPI, I2C"}, {"level": "level2", "index": 3, "label": "Memory Architecture and Management"}, {"level": "level3", "index": 0, "label": "Real-Time Operating Systems (RTOS)"}],
...
<li>Common pitfall: relying solely on \`printf\` — it changes timing and can mask race conditions</li>
        ...
        relatedTopics: [{"level": "level1", "index": 1, "label": "Microcontroller Architecture Fundamentals"}, {"level": "level1", "index": 2, "label": "Embedded C Programming Essentials"}, {"level": "level2", "index": 3, "label": "Memory Architecture and Management"}, {"level": "level3", "index": 0, "label": "Real-Time Operating Systems (RTOS)"}],
...
<li>Common pitfall: not validating the image before jumping — jumping to 0xFF... causes immediate fault</li>
        ...
        relatedTopics: [{"level": "level2", "index": 3, "label": "Memory Architecture and Management"}, {"level": "level1", "index": 2, "label": "Embedded C Programming Essentials"}, {"level": "level1", "index": 1, "label": "Microcontroller Architecture Fundamentals"}, {"level": "level3", "index": 4, "label": "Embedded Security Fundamentals"}],
...
<li>Common pitfall: hardcoded credentials or symmetric keys compiled into firmware binary</li>
        ...
        relatedTopics: [{"level": "level3", "index": 3, "label": "Bootloaders and Firmware Updates"}, {"level": "level2", "index": 3, "label": "Memory Architecture and Management"}, {"level": "level1", "index": 1, "label": "Microcontroller Architecture Fundamentals"}, {"level": "level4", "index": 0, "label": "Communication Protocols for IoT"}],
