...
<li>Protocol selection heuristic: distance, speed, pin count, multi-device needs</li>
        ...
        relatedTopics: [{"level": "level1", "index": 3, "label": "GPIO and Pin Control"}, {"level": "level1", "index": 4, "label": "Interrupts and Event-Driven Programming"}, {"level": "level2", "index": 2, "label": "Analog-to-Digital Conversion"}, {"level": "level3", "index": 1, "label": "Device Driver Development"}],
...
<li>Common pitfall: forgetting to start the timer after configuring it</li>
        ...
        relatedTopics: [{"level": "level1", "index": 3, "label": "GPIO and Pin Control"}, {"level": "level1", "index": 4, "label": "Interrupts and Event-Driven Programming"}, {"level": "level2", "index": 0, "label": "Serial Communication Protocols \u2014 UART, SPI, I2C"}, {"level": "level3", "index": 0, "label": "Real-Time Operating Systems (RTOS)"}],
...
<li>DAC basics: R-2R ladder, PWM + RC low-pass filter as a poor-man's DAC</li>
        ...
        relatedTopics: [{"level": "level1", "index": 1, "label": "Microcontroller Architecture Fundamentals"}, {"level": "level2", "index": 1, "label": "Timers, PWM, and Capture/Compare"}, {"level": "level2", "index": 0, "label": "Serial Communication Protocols \u2014 UART, SPI, I2C"}, {"level": "level2", "index": 4, "label": "Power Management and Low-Power Design"}],
...
<li>External QSPI Flash: XIP mode vs. indirect mode</li>
        ...
        relatedTopics: [{"level": "level1", "index": 1, "label": "Microcontroller Architecture Fundamentals"}, {"level": "level1", "index": 2, "label": "Embedded C Programming Essentials"}, {"level": "level3", "index": 3, "label": "Bootloaders and Firmware Updates"}, {"level": "level3", "index": 1, "label": "Device Driver Development"}],
...
<li>Common pitfall: DMA active during Stop mode preventing entry</li>
        ...
        relatedTopics: [{"level": "level1", "index": 3, "label": "GPIO and Pin Control"}, {"level": "level2", "index": 1, "label": "Timers, PWM, and Capture/Compare"}, {"level": "level1", "index": 4, "label": "Interrupts and Event-Driven Programming"}, {"level": "level3", "index": 0, "label": "Real-Time Operating Systems (RTOS)"}],
