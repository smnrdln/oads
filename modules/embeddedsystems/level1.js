...
<li>Common pitfall: integer promotion rules when operating on \`uint8_t\` in C</li>
        ...
        relatedTopics: [{"level": "level1", "index": 1, "label": "Microcontroller Architecture Fundamentals"}, {"level": "level1", "index": 3, "label": "GPIO and Pin Control"}, {"level": "level1", "index": 2, "label": "Embedded C Programming Essentials"}],
...
<li>Common pitfall: treating peripherals as memory without \`volatile\`</li>
        ...
        relatedTopics: [{"level": "level1", "index": 0, "label": "Digital Logic and Number Systems"}, {"level": "level1", "index": 2, "label": "Embedded C Programming Essentials"}, {"level": "level2", "index": 3, "label": "Memory Architecture and Management"}, {"level": "level3", "index": 3, "label": "Bootloaders and Firmware Updates"}],
...
<li>Common pitfall: uninitialized local variables producing non-deterministic behavior at power-on</li>
        ...
        relatedTopics: [{"level": "level1", "index": 0, "label": "Digital Logic and Number Systems"}, {"level": "level1", "index": 1, "label": "Microcontroller Architecture Fundamentals"}, {"level": "level1", "index": 4, "label": "Interrupts and Event-Driven Programming"}, {"level": "level3", "index": 1, "label": "Device Driver Development"}],
...
<li>Common pitfall: configuring alternate function mode before or after the peripheral clock enable</li>
        ...
        relatedTopics: [{"level": "level1", "index": 0, "label": "Digital Logic and Number Systems"}, {"level": "level1", "index": 1, "label": "Microcontroller Architecture Fundamentals"}, {"level": "level1", "index": 4, "label": "Interrupts and Event-Driven Programming"}, {"level": "level2", "index": 1, "label": "Timers, PWM, and Capture/Compare"}],
...
<li>Common pitfall: stack overflow from deeply nested interrupts</li>
        ...
        relatedTopics: [{"level": "level1", "index": 3, "label": "GPIO and Pin Control"}, {"level": "level1", "index": 1, "label": "Microcontroller Architecture Fundamentals"}, {"level": "level2", "index": 1, "label": "Timers, PWM, and Capture/Compare"}, {"level": "level3", "index": 0, "label": "Real-Time Operating Systems (RTOS)"}],
