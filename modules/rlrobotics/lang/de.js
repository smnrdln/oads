// Deutsch — RL für Robotik Modul
i18n.registerLanguage('de', 'Deutsch', {
    'app.title': 'RL für Robotik Trainer',
    ...
    'level.level1.name': 'Stufe 1: Mathematik, MDPs & tabellarisches RL',
    'level.level2.name': 'Stufe 2: Deep RL, PPO & Simulation',
    'level.level3.name': 'Stufe 3: Sim-to-Real, SAC/TD3 & Sicherheit',
    'level.level4.name': 'Stufe 4: Offline, Ziele & Capstone',
    'category.essential': 'Theorie & Sicherheit',
    'category.embedded': 'Algorithmen & Regelung',
    'category.robotics': 'Robotik & Einsatz',
    'welcome.heading': 'Willkommen beim Trainer RL für Robotik',
    ...
    'achievement.intermediate.title': 'Deep-RL-Praktiker',
    'achievement.intermediate.desc': 'Stufe 2 abgeschlossen',
    'achievement.advanced.title': 'Transfer & Sicherheit',
    'achievement.advanced.desc': 'Stufe 3 abgeschlossen',
    'achievement.expert.title': 'Robotik-RL-Integrator',
