i18n.registerContent('de', 'level3', [
    {
        title: "Koordinatensysteme und Sensorkalibrierung",
        content: `
<h3>Frames</h3>
...
<p>Handedness mistakes, sign conventions, and assuming calibration is permanent.</p>
        `,
        keyPoints: ["Viele Fehler sind Rahmen- oder Kalibrierfehler.", "Extrinsik und Zeitversatz beeinflussen Beobachtbarkeit.", "Kalibrierung braucht Validierung unter Bewegung.", "Ein Filter rettet keine systematisch falsch ausgerichteten Sensoren."],
    ...
    {
        title: "Erweitertes und unscented Kalman-Filtering",
        content: `
<h3>Nonlinearity</h3>
...
<p>Compare accuracy, tuning burden, computation, consistency, divergence, and covariance inflation.</p>
        `,
        keyPoints: ["EKF linearisiert lokal.", "UKF propagiert Sigma-Punkte.", "Bessere Nichtlinearität ersetzt kein gutes Modell.", "Initialisierung wird mit Nichtlinearität kritischer."],
    ...
    {
        title: "Fusionsarchitekturen und Zeitverwaltung",
        content: `
<h3>Architectures</h3>
...
<p>Aligning by arrival time, double-counting correlated information, and hidden feedback loops.</p>
        `,
        keyPoints: ["Architektur ist Systemdesign.", "Zeitfehler können Sensorqualität dominieren.", "Lose vs. enge Kopplung lösen unterschiedliche Probleme.", "Mehraten-Systeme brauchen Puffer und klare Update-Politik."],
