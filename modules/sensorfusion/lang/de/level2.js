...
<p>Confusing resolution with accuracy; over-reading noisy spectra; ignoring window effects.</p>
        `,
        keyPoints: ["Spektren machen periodische Anteile sichtbar.", "Fensterwahl beeinflusst Leakage.", "Frequenzauflösung hängt von der Aufzeichnungslänge ab.", "Spektren helfen bei Filterwahl und Störanalyse."],
    ...
    {
        title: "Digitale Filter und Glättung",
        content: `
<h3>FIR vs IIR</h3>
...
<p>A simple fusion bridge when sensors have complementary frequency strengths.</p>
        `,
        keyPoints: ["Filter sind Kompromisse, nicht maximal glatt.", "FIR ist oft verständlicher, IIR oft effizienter.", "Phasenverzug kann Regelung und Tracking stören.", "Komplementärfilter sind oft der einfachste Fusionskern."],
    ...
    {
        title: "Zustandsraummodelle und Kalman-Filter",
        content: `
<h3>Models</h3>
...
<p>Observability basics, tuning logic, and why a wrong model can look stable while being wrong.</p>
        `,
        keyPoints: ["Kalman-Filter kombinieren Vorhersage und Messung.", "Q modelliert Prozessunsicherheit, R das Messvertrauen.", "Innovation ist das wichtigste Diagnosesignal.", "Ein falsches Modell kann stabil wirken und trotzdem falsch sein."],
