i18n.registerContent('en', 'level1', [
    {
        title: "Signals, Systems, and Sensor Data",
        content: `
<h3>Vocabulary</h3>
...
<div class="visual-ref-links">
    <button class="visual-ref-btn" onclick="openVisualRef('https://www.google.com/search?igu=1&q=Nyquist+sampling+diagram+sensor+fusion&udm=2')">🔍 Sampling intuition</button>
        ...
        `,
        keyPoints: ["A sensor output is a noisy measurement, not the state itself.", "Good fusion starts with clean definitions of signal, state, and measurement.", "Units, timestamps, and sensor limits matter as much as algorithms.", "Many fusion bugs are data-quality or metadata bugs."],
...
<ul>
    ...
    <li>Assuming more samples always recover lost bandwidth</li>
        ...
        `,
        keyPoints: ["Sampling changes what can be known from a signal.", "Frequencies above half the sampling rate can fold into false lower frequencies.", "Anti-aliasing belongs in system design, not just post-processing.", "Resampling never recreates information that was never captured."],
    ...
    {
        title: "Noise, Statistics, and Basic Filtering",
        content: `
<h3>Statistics</h3>
...
<p>Use residuals and summary statistics deliberately—outlier handling should be explicit.</p>
        `,
        keyPoints: ["Not all uncertainty is the same; bias, drift, and random noise behave differently.", "Filtering trades variance reduction for delay, distortion, or both.", "Covariance matters because fusion is about relationships across channels.", "Outlier handling should be explicit, not accidental."],
